...
/* Translated by @heenji */
	...
	$lang['form_save_and_go_back']	= '保存并返回';
	$lang['form_update_and_go_back']= '更新并返回';

	/* Upload functionality */
	$lang['string_delete_file'] 	= "删除文件";
	$lang['string_progress'] 		= "进度";
	$lang['error_on_uploading'] 	= "上传是出现错误";
	$lang['message_prompt_delete_file'] 	= "确定删除文件？";

	$lang['error_max_number_of_files'] 	= "一次只能上传一个文件";
	$lang['error_accept_file_types'] 	= "不允许这种扩展名的文件";
	$lang['error_max_file_size'] 		= "The uploaded file exceeds the {max_file_size} directive that was specified.";
	$lang['error_min_file_size'] 		= "你不能上传空文件。";
